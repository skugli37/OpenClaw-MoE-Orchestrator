...
class SlidingWindowAttention(nn.Module):
    ...
    def _sliding_window_attention(self, q, k, v, mask):
        ...
        # Unfold for sliding window - fix: reshape after unfold
        ...
        # Reshape for einsum: (batch, heads, seq_len, window_size, head_dim)
        # k_windows shape after unfold: (batch, heads, seq_len, head_dim, window_size)
        # Permute to (batch, heads, seq_len, window_size, head_dim)
